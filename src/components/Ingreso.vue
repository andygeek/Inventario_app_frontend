            ...
            <v-container grid-list-sm class="pa-4 white" v-if="verNuevo">
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm12 md12 lg12 xl12>
                        ...
                        <v-flex class="text-xs-right">
                            <strong>Total Impuesto: </strong>S/. {{totalImpuesto=(total*(impuesto/100)).toFixed(2)}}
                        </v-flex>
                        <v-flex class="text-xs-right">
        ...
        methods:{
             crearPDF(){
                var columns = [
                    ...
                    {title: "Nº Compr.", dataKey: "num_comprobante"}, 
                ...
                this.ingresos.map(function(x){
                    rows.push({usuario:x.usuario,proveedor:x.proveedor,num_comprobante:x.num_comprobante,fecha:x.fecha_hora,total:x.total});
                });
